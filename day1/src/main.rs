...
fn day_1_1(list: Vec<&str>) -> usize {
    ...
    println!("Ответ на первую часть первого дня: {} ", sum);
...
mod tests {
    ...
    fn test_day_1_1() {
        assert_eq!(
            day_1_1(["1abc2", "pqr3stu8vwx", "a1b2c3d4e6f", "treb7uchet"].to_vec()),
            143
        );
        assert_eq!(day_1_1(MAIN_LIST.to_vec()), 55477);
    }
}